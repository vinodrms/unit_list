...
export class UpdatePriceProductItemStatus {
	...
	public updateStatus(inputDO: PriceProductInputIdDO, oldStatus: PriceProductStatus, newStatus: PriceProductStatus): Promise<PriceProductDO> {
