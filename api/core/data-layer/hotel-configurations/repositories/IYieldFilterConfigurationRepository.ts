...
export interface IYieldFilterConfigurationRepository {
    ...
    addYieldFilterValue(meta: HotelConfigurationMetaRepoDO, filterMeta: YieldFilterMetaRepoDO, yieldFilterValue: YieldFilterValueDO): Promise<YieldFilterValueDO>;
    updateYieldFilterValue(meta: HotelConfigurationMetaRepoDO, filterMeta: YieldFilterMetaRepoDO, filterValueMeta: YieldFilterValueMetaRepoDO, yieldFilterDO: YieldFilterValueDO): Promise<YieldFilterValueDO>;
}