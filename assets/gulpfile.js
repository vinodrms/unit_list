...
gulp.task('pack-internal', ['compile-internal'], function (endCallback) {
	packCompiledFiles('systemjs.internal.config.js', 'unitpal-internal-1.0.66.min.js', 'internal', endCallback);
});
...
gulp.task('pack-external', ['compile-external'], function (endCallback) {
	packCompiledFiles('systemjs.external.config.js', 'unitpal-external-1.0.66.min.js', 'external', endCallback);
});
