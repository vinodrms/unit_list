    ...
    template: `
		<div class="form-group">
            ...
            <div class="input-group">
                <span *ngIf="showIcon" class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
                <input type="text" class="form-control" #inputDate [readonly]="readonly" />
            </div>
		</div>
	`
})
export class ThDatePickerComponent implements AfterViewInit {
    @ViewChild('inputDate') element: ElementRef;
