export var EnglishTranslations: Object = {
    ...
    "Each adult is replaceable with a child. Possible configurations:": "Each adult is replaceable with a child. Possible configurations:",
	...
	"The price of the breakfast will be included in the RevPar and Room Revenue.": "The price of the breakfast will be included in the RevPar and Room Revenue.",
	...
	"Add On Products": "Add On Products",
	"You can include Add On Products in the Price Product that will appear as separate items on the invoice. Their price is included in the Price Product.": "You can include Add On Products in the Price Product that will appear as separate items on the invoice. Their price is included in the Price Product.",
	...
	"Must arrive on days from week": "Must arrive on days from week",
	...
	"If selected, it means that you have an agreement with the company to pay invoices.": "If selected, it means that you have an agreement with the company to pay invoices.",
