...
@Component({
	...
	templateUrl: '/client/src/pages/internal/containers/home/pages/home-pages/booking-history/template/booking-history-container.html'
})

export class BookingHistoryDashboardComponent extends AHomeContainerComponent implements OnInit {
