...
import { BookingUnreserveRoomComponent } from "./components/unreserve-room/BookingUnreserveRoomComponent";
...
@NgModule({
    ...
    declarations: [BookingOperationsPageComponent,
        ...
        BookingUndoCheckInComponent, BookingUnreserveRoomComponent],
