...
import {WizardBasicInfoNameAddressService} from '../pages/wizard-pages/basic-information/pages/name-address/services/WizardBasicInfoNameAddressService';
...
@Component({
	...
	providers: [WizardBasicInfoIntroService, WizardBasicInfoNameAddressService,
