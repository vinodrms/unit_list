...
export class WizardRoomsComponent extends BaseComponent implements OnInit, AfterViewInit {
    ...
    private initializeWizardStepsComponent() {
        this._roomsComponent.bootstrapOverviewBottom(WizardStepsModule, WizardStepsComponent, ReflectiveInjector.resolve([{ provide: WizardService, useValue: this._wizardService }]));
    }
