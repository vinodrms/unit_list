...
export abstract class AInventoryState<T> implements IInventoryState<T> {
    ...
    protected confirmDataDiscard(onConfirmCallback: { (): void }, onRejectCallback?: { (): void }) {
        ...
        this._appContext.modalService.confirm(title, content, { positive: this._appContext.thTranslation.translate("Yes"), negative: this._appContext.thTranslation.translate("No") }, onConfirmCallback, onRejectCallback);
    }
