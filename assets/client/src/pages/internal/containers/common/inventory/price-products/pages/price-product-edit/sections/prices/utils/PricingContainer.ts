...
export class PricingContainer {
    ...
    public addDynamicPrice(newDynamicPrice: DynamicPriceVM) {
        ...
        firstPricePerPersonDynamicPriceClone.dynamicPriceDO.priceExceptionList = [];
        firstPricePerPersonDynamicPriceClone.resetExceptions();
        delete firstPricePerPersonDynamicPriceClone.dynamicPriceDO['id'];
        ...
        firstSinglePriceDynamicPriceClone.dynamicPriceDO.priceExceptionList = [];
        firstSinglePriceDynamicPriceClone.resetExceptions();
        delete firstSinglePriceDynamicPriceClone.dynamicPriceDO['id'];
