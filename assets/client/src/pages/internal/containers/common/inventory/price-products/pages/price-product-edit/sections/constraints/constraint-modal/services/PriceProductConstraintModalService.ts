...
import {PriceProductConstraintModalModule} from '../PriceProductConstraintModalModule';
...
export class PriceProductConstraintModalService {
	...
	public openPriceProductConstraintsModal(): Promise<ModalDialogRef<PriceProductConstraintDO>> {
		return this._appContext.modalService.open<any>(PriceProductConstraintModalModule, PriceProductConstraintModalComponent, ReflectiveInjector.resolve([]));
	}
}