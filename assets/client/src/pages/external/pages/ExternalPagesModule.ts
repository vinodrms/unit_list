...
import { AccountWasCreatedComponent } from './account-was-created/AccountWasCreatedComponent';

@NgModule({
    imports: [CommonModule, RouterModule, ReactiveFormsModule,
        SharedPipesModule, SharedComponentsModule, ExternalFooterModule],
    declarations: [LogInComponent, ResetPasswordComponent, SignUpComponent, UpdatePasswordComponent, AccountWasCreatedComponent],
    exports: [LogInComponent, ResetPasswordComponent, SignUpComponent, UpdatePasswordComponent, AccountWasCreatedComponent],
})
